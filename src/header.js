...
export const header = () => {
  ...
  const attHome = document.createAttribute('data-tab-target');
  attHome.value = '#home';
  listHome.setAttributeNode(attHome);
  const attAbout = document.createAttribute('data-tab-target');
  attAbout.value = '#about';
  listAbout.setAttributeNode(attAbout);
  const attMenu = document.createAttribute('data-tab-target');
  attMenu.value = '#menu';
  listMenu.setAttributeNode(attMenu);
  const attContact = document.createAttribute('data-tab-target');
